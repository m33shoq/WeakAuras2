...
L["Additional Trigger Replacements"] = [=[추가 트리거 텍스트 교체 패턴
]=]
...
L["Armor Peneration Percent"] = "방어구 관통률"
L["Armor Peneration Rating"] = "방어구 관통 지수"
L["Armor Rating"] = "방어도"
L["Array"] = "정렬"
L["Ascending"] = "오름차순"
...
L["Blocked"] = "방패 막기"
L["Blood"] = "혈기"
L["Blood Prince Council"] = "공작 발라나르"
...
L["Northrend Beasts"] = "공포비늘"
L["Not in Group"] = "그룹에 없음"
L["Not in Smart Group"] = "스마트 그룹에 없음"
L["Not on Cooldown"] = "쿨타임이 아닐 때"
L["Not On Threat Table"] = "위협 수준 없음"
L["Note, that cross realm transmission is possible if you are on the same group"] = [=[영역 간 전송이 가능합니다,
같은 그룹에 있다면]=]
...
L["Set IDs can be found on websites such as wowhead.com/wotlk/item-sets"] = "세트 ID는 wowhead.com/wotlk/item-sets에서 찾을 수 있습니다."
...
L["Show On"] = "표시 조건"
L["Show Override"] = "오버라이드 주문 표시"
L["Show Override Spell"] = "오버라이드 스펠 표시"
...
L["The trigger number is optional, and uses the trigger providing dynamic information if not specified."] = "트리거 번호는 선택 사항입니다. 지정하지 않으면 현재 동적 정보를 제공하는 트리거를 사용합니다."
